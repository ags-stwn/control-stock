                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Row(
                          children: [
                            Icon(Icons.compare_arrows, size: 20, color: Colors.blue),
                            SizedBox(width: 8),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Row(
                            children: [
                              Icon(Icons.calendar_month, size: 20, color: Colors.orange),
                              SizedBox(width: 8),
                              Text("RINCIAN PER WEEKLY (GWS)", style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Wrap(
                        ...
                        children: [
                          const Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text("RINCIAN PER WEEKLY (NON GWS)", style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Wrap(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  _buildHeaderCell("TICKET BC", flex: 2),
                  ...
                  GestureDetector(
                    ...
                    child: _buildHeaderCell("Weekly", flex: 2),
                  ),
                  _buildHeaderCell("QTY", flex: 2),
                  _buildHeaderCell("CEK OKE", flex: 1),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        _buildCell("${index + 1}", flex: 1),
                        _buildCell(item['ticket_bc'] ?? '-', flex: 2, fontSize: 11, color: textColor),
                        _buildCell(
                          (item['code'] ?? '-').toString().toUpperCase(), 
                          flex: 2, 
                        ...
                        _buildCell(item['lokasi'] ?? '-', flex: 2, fontSize: 11, color: textColor),
                        _buildCell(item['weekly'] ?? '-', flex: 2, color: textColor),
                        _buildCell(
                          "${item['qty'] ?? 0}", 
                          flex: 2, 
                          fontWeight: FontWeight.bold,
